...
while (computerScore < 3 || userScore < 3) {
  ...
  if (
    ...
    if (computerChoice === choose) {
      console.log("Both are the same, No Score!!");
      console.log("=======================================");
    } else if (computerChoice === "Rock" && choose === "Scissor") {
      computerScore += 1;
      console.log("computer scores: ", computerScore);
      console.log("Your scores: ", userScore);
      console.log("=======================================");
    } else if (computerChoice === "Rock" && choose === "Paper") {
      userScore += 1;
      console.log("computer scores: ", computerScore);
      console.log("Your scores: ", userScore);
      console.log("=======================================");
    } else if (computerChoice === "Paper" && choose === "Scissor") {
      userScore += 1;
      console.log("computer scores: ", computerScore);
      console.log("Your scores: ", userScore);
      console.log("=======================================");
    } else if (computerChoice === "Paper" && choose === "Rock") {
      computerScore += 1;
      console.log("computer scores: ", computerScore);
      console.log("Your scores: ", userScore);
      console.log("=======================================");
    } else if (computerChoice === "Scissor" && choose === "Rock") {
      userScore += 1;
      console.log("computer scores: ", computerScore);
      console.log("Your scores: ", userScore);
      console.log("=======================================");
    } else if (computerChoice === "Scissor" && choose === "Paper") {
      computerScore += 1;
      console.log("computer scores: ", computerScore);
      console.log("Your scores: ", userScore);
      console.log("=======================================");
